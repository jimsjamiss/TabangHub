...
import Nav from '../orgdashboard/components/orgNav/page';
...
export default function Inbox() {
  const [messages, setMessages] = useState([
    { id: 1, sender: 'Clean-Up Drive 2024', content: 'Hey! How are you?', time: '10:45 AM', unread: true, avatar: 'J' },
    { id: 2, sender: 'Webinar for First-Aid', content: 'Meeting is rescheduled to tomorrow.', time: '9:30 AM', unread: false, avatar: 'JS' },
    { id: 3, sender: 'Tree Planting Program', content: 'Can you review the document?', time: 'Yesterday', unread: false, avatar: 'B' },
