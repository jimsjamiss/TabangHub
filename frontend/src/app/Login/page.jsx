      ...
      <form class="max-w-96 mx-auto" >
        ...
        <div class="flex items-start mb-5">
          <div class="flex items-center h-5">
            ...
            <Link href="/Register" class="block mb-4 text-sm font-medium text-black-900 dark:text-black pl-24 underline text-blue-800 ml-5">Create Account</Link>
        </div>
            ...
            <button type="button" class="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-full text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2">
            ...
            <button type="button" class="text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-full text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 mb-2">
