...
const pages = [
  ...
  <a href='/users/offers'>Services</a>, 
  <a href='/users/volunteers'>Volunteers</a>
];

const settings = [
  { label: "Profile", icon: <PersonRoundedIcon fontSize="small" />, link: "/users/profile" },
  { label: "History", icon: <HistoryRoundedIcon fontSize="small" />, link: "/users/userHistory" },
